  ...
  const links = [
    {
      ...
      color: "hover:bg-green-500/20 hover:text-green-600",
    },
    {
      name: "LinkedIn",
    ...
    >
      {links.map((link) => (
        <a
          ...
          className={`p-1.5 rounded-full bg-background/80 backdrop-blur-sm border border-border/50 transition-all ${link.color}`}
