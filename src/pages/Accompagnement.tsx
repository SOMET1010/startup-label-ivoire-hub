...
const structures = [
  {
    ...
    programs: [
      { name: "Orange Fab", duration: "6 mois", description: "Programme d'accélération pour startups matures." },
      { name: "Orange Fab Academy", duration: "3 mois", description: "Formation et mentorat pour entrepreneurs early-stage." }
    ]
  },
  {
    id: 2,
    ...
    programs: [
      { name: "Green Start", duration: "9 mois", description: "Incubation complète pour projets écologiques." }
    ]
  },
  {
    id: 3,
    ...
    programs: [
      { name: "Seedstars Growth", duration: "4 mois", description: "Accélération avec possibilité d'investissement." }
    ]
  },
  {
    id: 4,
    ...
    programs: [
      { name: "YTH Starter", duration: "12 mois", description: "Programme d'incubation complet." },
      { name: "Tech4Women", duration: "6 mois", description: "Programme dédié aux femmes entrepreneures." }
    ]
  },
  {
    id: 5,
    ...
    programs: [
      { name: "Tech Venture Builder", duration: "12 mois", description: "Co-création de startups deep tech." }
    ]
  },
  {
    id: 6,
    ...
    programs: [
      { name: "Fast Track", duration: "3 mois", description: "Accélération intensive pour startups avec MVP." }
    ]
  },
];
